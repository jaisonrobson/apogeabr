                                ...
                                <Row width="100%" gap="2rem">
                                    <Col>
                                        <SearchableConnectedPaginatedTable
                                            ...
                                            endpoint={`${[process.env.REACT_APP_BACKEND_HOST]}/items`}
                                        >
                                            {({ payload, headerCount }) => (
                                                <Fragment>
                                                    <Table.Header>
                                                    ...
                                                    <Table.Body>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            <DeleteRecordModalButton
                                                                                ...
                                                                                deleteRoutePath={ROUTES.USER_ADMIN_PANEL_LIBRARYANDMAP_ITEMS.path}
                                                                            />
                                                                        </Col>
                                                                    </Row>
                                                                </Table.Cell>
                                                        ...
                                                        <Table.Row light>
                                                            <CreateItemFormModal headerCount={headerCount} />
                                                        </Table.Row>
                                                    </Table.Body>
                                                </Fragment>
                                            )}
