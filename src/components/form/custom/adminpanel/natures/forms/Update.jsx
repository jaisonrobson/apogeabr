...
const Update = ({ nature }) => (
    <RecordFormModal
        ...
        formComponentProps={({ dynamicFields, isOpen, fetchingPayload }) => ({
            ...
            lateLoadingValues: () => ({
                icon_id: nature.icon_id,
                image: nature?.image ? urlToFile(nature.image) : null,
                ...extractIntoFlatObjectFieldsByName({
                    initialData: dynamicFields,
                    byName: "name",
                    fieldName: "value",
        ...
        inputsComponent={NatureFormInputs}
        submitButtonProps={{
            color: "white",
        ...
        fetchingRequests={[
            ...
            {
                actionMethod: "GET",
                actionRoute: `natures/${nature.id}/translations`,
            }
        ]}
        ...
        fetchingPayloadHelpers={[
            ...
            (data) => {
                ...
                const existingModelIds = _.uniq(_.map(data.payload, 'nature_id'))
