...
const Update = ({ trait }) => (
    <RecordFormModal
        ...
        formComponentProps={({ dynamicFields, isOpen, fetchingPayload }) => ({
            ...
            lateLoadingValues: () => ({
                icon_id: trait.icon_id,
                slots: Number(trait.slots),
                ...extractIntoFlatObjectFieldsByName({
                    initialData: dynamicFields,
                    byName: "name",
                    fieldName: "value",
        ...
        fetchingRequests={[
            ...
            {
                actionMethod: "GET",
                actionRoute: `traits/${trait.id}/translations`,
            }
        ]}
        ...
        fetchingPayloadHelpers={[
            ...
            (data) => {
                ...
                const existingModelIds = _.uniq(_.map(data.payload, 'trait_id'))
